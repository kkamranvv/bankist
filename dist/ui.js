...
import { labelBalance, labelSumIn, labelSumOut, labelSumInterest, containerMovements, } from '../src/dom';
export const displayMovements = (acc, sort = false) => {
    ...
    combinedMovsDates.forEach((obj, i) => {
        ...
        const displayDate = formatMovementDate(new Date(obj.movementDate), acc.locale);
